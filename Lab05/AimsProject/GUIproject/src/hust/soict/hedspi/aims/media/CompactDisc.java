...
public class CompactDisc extends Disc implements Playable {
	...
	public void addTrack(Track track) {
		if (!tracks.contains(track)) {
			tracks.add(track);
			System.out.println("Phuc Thanh || " + track + "is added successfully");
		}
	...
	public void removeTrack(Track track) {
		if (tracks.contains(track)) {
			tracks.remove(track);
			System.out.println("Phuc Thanh || " + track + "is removed successfully");
		} else {
			System.out.println("Phuc Thanh || " + track + "is not in the track list");
		}
	}
